...
# import package needed for plotting functions
import matplotlib.pyplot as plt

def plotfun(time, timemax, SNR, pcolor, det, eventname, plottype, tevent, strain_whitenbp, template_match, template_fft, d_eff, freqs, data_psd, datafreq, fs):
